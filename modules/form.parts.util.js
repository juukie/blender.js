...
__.parseFormJson = function(parts) {
...
__.renderImage = function(data, full) {
...
__.preserveWidthOnDrag = function(e, ui) {
...
__.clearAlerts = function(where) {
    where.empty();
}

__.writeAlert = function(msg, type, where) {
...
__.isNormalPositiveInteger = function(str) {
    var n = ~~Number(str);
