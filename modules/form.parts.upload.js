...
__.enableUpload = function(parts) {

    __.constructUploadField(parts);

    var dropZone = __.enableDropZone(parts);

    var uploadOptions = __.constructUploadOptions(parts, dropZone);

    // clear errors
    parts.$uploadField.on('click',function(e){
        __.clearAlerts(parts.$uploadAlerts);
    });
...
__.constructUploadField = function(parts) {
...
__.enableDropZone = function(parts) {
...
__.constructUploadOptions = function(parts, dropZone) {
